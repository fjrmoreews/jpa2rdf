...
public class MainEntityExample {
	...
	public static void testMultiFormat(String[] args) throws FileNotFoundException {
		   ...
		   // s0.save();
			...
			writeToFile(om, "test/workingsong-ontomodel-without-load2_rdf_xml.rdf", "RDF/XML");
		  ...
		  writeToFile(m1, "test/workingsong-defaultmodel-with-without-load2.rdf", "RDF/XML");  
